...
hi TablineSel                 ctermfg=238   ctermbg=7     cterm=none
...
hi WildMenu                   ctermfg=4     ctermbg=238   cterm=bold
hi User1                      ctermfg=1     ctermbg=238
hi User2                      ctermfg=2     ctermbg=238
hi User3                      ctermfg=3     ctermbg=238
hi User4                      ctermfg=4     ctermbg=238
hi User5                      ctermfg=5     ctermbg=238
hi User6                      ctermfg=6     ctermbg=238
hi User7                      ctermfg=7     ctermbg=238
hi User8                      ctermfg=7     ctermbg=236
hi User9                      ctermfg=8     ctermbg=0
